...
class DraggableObjectGame:
    def __init__(self, width=800, height=600):
        pygame.init()
        self.screen = pygame.display.set_mode((width, height), pygame.RESIZABLE)
        pygame.display.set_caption("果醬吐司")
        ...
        self.image1 = pygame.image.load(resource_path("images/ToastOnFloor.png"))
        self.image2 = pygame.image.load(resource_path("images/Toast.png"))
        self.image3 = pygame.image.load(resource_path("images/ToastFly.png"))
